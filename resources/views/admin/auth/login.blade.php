            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="absolute top-6 end-6">
                            <div class="dropdown" x-data="dropdown" @click.outside="open = false">
                                <a href="javascript:;"
                                    class="flex gap-2.5 items-center px-2 py-1.5 bg-white rounded-lg border border-white-dark/30 text-white-dark hover:border-primary hover:text-primary dark:bg-black"
                        ...
                        <div class="mx-auto w-full max-w-[440px]">
                            ...
                            <form class="space-y-5 dark:text-white" method="post" action="{{ route('admin.login') }}">
                                @csrf
                                <div>
                    ...
                    <p class="absolute bottom-6 w-full text-center dark:text-white">
                        <span id="footer-year">2024</span>. Starter Kit
                        {{ __('COPYRIGHT') }}
                    </p>
                </div>
            </div>
