<header class="z-40" :class="{ 'dark': $store.app.semidark && $store.app.menu === 'horizontal' }">
    <div class="shadow-sm">
        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="flex justify-between items-center horizontal-logo ltr:mr-2 rtl:ml-2 lg:hidden">
                <a href="/">
                    <img class="inline object-cover w-8 rounded-full ltr:-ml-1 rtl:-mr-1" src="{{asset("assets/images/g-8.png")}}"
                        alt="image" />
                </a>
                <span
                    class="hidden text-2xl font-semibold align-middle transition-all duration-300 dark:text-white-light md:inline ltr:ml-1 rtl:mr-1">Starter
                    Kit</span>
            ...
            <div x-data="header"
                ...
                <div class="dropdown shrink-0" x-data="dropdown" @click.outside="open = false">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        <template x-for="item in languages">
                            <li>
                                <a href="javascript:;" :href="item.href" class="hover:text-primary"
                ...
                <div class="flex-shrink-0 dropdown" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="relative group" @click="toggle()">
                        <span><img src="{{ asset('assets/images/profile.jpeg') }}"
                                class="object-cover w-9 h-9 rounded-full saturate-50 group-hover:saturate-100" />
                        </span>
                    </a>
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                            ...
                            <div class="flex items-center px-4 py-4">
                                <div class="flex-none">
                                    <img class="object-cover w-10 h-10 rounded-md"
                                        src="{{ asset('assets/images/profile.jpeg') }}" alt="image" />
                                </div>
                                <div class="truncate ltr:pl-4 rtl:pr-4">
                                    <h4 class="text-base">
                                        {{ Auth::user()->username }}
                                        <span
                                            class="px-1 text-xs rounded bg-success-light text-success ltr:ml-2 rtl:ml-2">
                                            {{ Auth::user()->roles->first()->name }}
                                        </span>
                                    </h4>
                                    <a class="text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white"
                                    href="javascript:;">{{ Auth::user()->email ?? Auth::user()->phone }}</a>
                                </div>
                            </div>
                        </li>
                        <li>
                        ...
                        <li class="border-t border-white-light dark:border-white-light/10">
                            <a href="{{ route('admin.logout') }}" class="!py-3 text-danger" @click="toggle">
                                <svg class="rotate-90 h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2" width="18"
